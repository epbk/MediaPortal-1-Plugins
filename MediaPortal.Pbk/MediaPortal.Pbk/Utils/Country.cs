...
namespace MediaPortal.Pbk.Utils
{
    ...
    public class Country
    {
        ...
        public string NameAlternate { get; private set; }
        public string TwoLetterCode { get; private set; }
        public string ThreeLetterCode { get; private set; }
        public int NumericCode { get; private set; }

        private Country(string strName, string strTwoLetterCode, string strThreeLetterCode, int iNumericCode, string strNameAlt = null)
        {
            Name = strName;
            NameAlternate = strNameAlt;
            TwoLetterCode = strTwoLetterCode;
            ThreeLetterCode = strThreeLetterCode;
            NumericCode = iNumericCode;
        }
        ...
        public static readonly Country[] List = new[]
        {
            ...
            new Country("Bolivia, Plurinational State of", "BO", "BOL", 068, "Bolivia"),
            ...
            new Country("Czechia", "CZ", "CZE", 203, "Czech Republic"),
            ...
            new Country("Korea, Democratic People's Republic of", "KP", "PRK", 408, "North Korea"),
            new Country("Korea, Republic of", "KR", "KOR", 410, "South Korea"),
            ...
            new Country("Moldova, Republic of", "MD", "MDA", 498, "Moldova"),
            ...
            new Country("United Kingdom of Great Britain and Northern Ireland", "GB", "GBR", 826, "United Kingdom"),
            new Country("United States of America", "US", "USA", 840, "United States"),
            ...
            new Country("Venezuela, Bolivarian Republic of", "VE", "VEN", 862, "Venezuela"),
            ...
            new Country("Kosovo", "XK", "XKX", 383)
            };

        public static Country FindByName(string strName)
        {
            for (int i = 0; i < List.Length; i++)
            {
                Country c = List[i];

                if (c.Name.Equals(strName, System.StringComparison.CurrentCultureIgnoreCase) ||
                    (c.NameAlternate != null && c.NameAlternate.Equals(strName, System.StringComparison.CurrentCultureIgnoreCase)))
                    return c;
            }
        ...
        public static Country FindByTwoLetterCode(string strCode)
        {
            for (int i = 0; i < List.Length; i++)
            {
                if (List[i].TwoLetterCode.Equals(strCode, System.StringComparison.CurrentCultureIgnoreCase))
                    return List[i];
            }
        ...
        public static Country FindByThreeLetterCode(string strCode)
        {
            for (int i = 0; i < List.Length; i++)
            {
                if (List[i].ThreeLetterCode.Equals(strCode, System.StringComparison.CurrentCultureIgnoreCase))
                    return List[i];
            }
        ...
        public static Country FindByNumericCode(int iCode)
        {
            for (int i = 0; i < List.Length; i++)
            {
                if (List[i].NumericCode == iCode)
                    return List[i];
            }
