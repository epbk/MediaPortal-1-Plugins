...
namespace MediaPortal.Pbk.Cornerstone.Extensions.IO
{
    public static class PathStringExtensions
    {
        ...
        /// </summary>
        /// <param name="strOldFilePath">Full path of old file</param>
        /// <param name="strNewFilePath">Full path of where to move new file</param>
        /// <returns>True if move was successful</returns>
        public static bool MoveTo(this string strOldFilePath, string strNewFilePath)
        {
            try
            {
