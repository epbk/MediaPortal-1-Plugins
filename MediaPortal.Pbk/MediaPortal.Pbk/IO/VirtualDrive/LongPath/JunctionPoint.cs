...
using Path = MediaPortal.Pbk.IO.VirtualDrive.LongPath.Path;
using Directory = MediaPortal.Pbk.IO.VirtualDrive.LongPath.Directory;
using File = MediaPortal.Pbk.IO.VirtualDrive.LongPath.File;
using DirectoryInfo = MediaPortal.Pbk.IO.VirtualDrive.LongPath.DirectoryInfo;
using FileInfo = MediaPortal.Pbk.IO.VirtualDrive.LongPath.FileInfo;
using FileSystemInfo = MediaPortal.Pbk.IO.VirtualDrive.LongPath.FileSystemInfo;
